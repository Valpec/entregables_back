...
router.post('/:cid/product/:pid', passportCall('jwt'), authorization('user'), postCartIdController)

//DELETE del producto seleccionado del carrito
router.delete('/:cid/product/:pid', passportCall('jwt'), authorization('user'), deleteCartProdIdController)
